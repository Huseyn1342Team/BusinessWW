...
public class FriendRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog csprogress=new ProgressDialog(FriendRequest.this);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(FriendRequest.this);
        ...
        DatabaseReference db1 = FirebaseDatabase.getInstance().getReference().child("Users").child(MyUid).child("FriendRequest");
        db1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FriendRequestAdapter adapter = new FriendRequestAdapter(FriendRequest.this,list);
