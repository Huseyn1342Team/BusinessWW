...
public class ProducerRequest_settings extends AppCompatActivity {
    private RecyclerView PostList;
    private ArrayList<FriendRequestModel> list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_producer_request_settings);
        ...
        final ProgressDialog csprogress=new ProgressDialog(ProducerRequest_settings.this);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(ProducerRequest_settings.this);
        ...
        db1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ProducerRequest_adapter adapter = new ProducerRequest_adapter(ProducerRequest_settings.this,list);
