...
public class AskAndAnswer_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ask_and_answer_1);
        ...
        ComputerScience.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(AskAndAnswer_1.this,AskAndAnswer_2.class);
