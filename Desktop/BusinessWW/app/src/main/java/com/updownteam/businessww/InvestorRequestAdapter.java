...
public class InvestorRequestAdapter extends RecyclerView.Adapter<InvestorRequestAdapter.ViewHolder> {

    private List<FriendRequestModel> mData;
    private LayoutInflater mInflater;

    // data is passed into the constructor
    InvestorRequestAdapter(Context context, List<FriendRequestModel> data) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.Agree.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference d1 = FirebaseDatabase.getInstance().getReference().child("Users").child(ss);
                d1.child("Investor").child("Request").child(MyUid).removeValue();
                d1.child("Investors").child(MyUid).child("uid").setValue(MyUid);
