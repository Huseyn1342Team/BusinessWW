...
public class investorfindersearch_adapter extends RecyclerView.Adapter<investorfindersearch_adapter.ViewHolder> {

    private List<investorfindersearch_model> mData;
    private LayoutInflater mInflater;

    // data is passed into the constructor
    investorfindersearch_adapter(Context context, List<investorfindersearch_model> data) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.Accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(mInflater.getContext(),investorfindersearch2.class);
