...
public class InvestorRequest_settings extends AppCompatActivity {
    private RecyclerView PostList;
    private ArrayList<FriendRequestModel> list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_investor_request_settings);
        ...
        final ProgressDialog csprogress=new ProgressDialog(InvestorRequest_settings.this);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(InvestorRequest_settings.this);
        ...
        db1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                InvestorRequestAdapter adapter = new InvestorRequestAdapter(InvestorRequest_settings.this,list);
