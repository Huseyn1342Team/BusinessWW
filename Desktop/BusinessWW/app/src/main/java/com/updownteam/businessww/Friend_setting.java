...
public class Friend_setting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog csprogress=new ProgressDialog(Friend_setting.this);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(Friend_setting.this);
        ...
        db1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Friend_settings_adapter adapter = new Friend_settings_adapter(Friend_setting.this,list);
