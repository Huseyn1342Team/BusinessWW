...
public class Producer_1 extends AppCompatActivity {
    private EditText Price;
    private Button Submit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_producer_1);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(price.matches("")){
                    Toast.makeText(Producer_1.this,"Sorry, you must write something",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                db1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("Producer")){
                            ...
                            Intent i =new Intent(Producer_1.this,InvestorMain2.class);
                            startActivity(i);
                        }else{
                            Intent i =new Intent(Producer_1.this,Producer_2.class);
