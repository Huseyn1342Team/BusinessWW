...
public class Producer_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_producer_2);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(character.matches("")){
                    Toast.makeText(Producer_2.this,"Sorry,you must write something",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                db1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("Producer")){
                            ...
                            Intent i =new Intent(Producer_2.this,InvestorMain2.class);
                            startActivity(i);
                        }else{
                            Intent i =new Intent(Producer_2.this,Producer_3.class);
