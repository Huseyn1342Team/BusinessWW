...
public class producerfindersearch1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_producerfindersearch1);
        ...
        final ProgressDialog csprogress=new ProgressDialog(producerfindersearch1.this);
        ...
        Toast.makeText(producerfindersearch1.this,Country+Category+Amount,Toast.LENGTH_SHORT).show();
        PostDisplay();
    }
    private void PostDisplay(){
        PostList = (RecyclerView)findViewById(R.id.postlist);
        LinearLayoutManager layoutManager = new LinearLayoutManager(producerfindersearch1.this);
        layoutManager.setReverseLayout(true);
        layoutManager.setStackFromEnd(true);
        PostList.setLayoutManager(layoutManager);
        list = new ArrayList<>();
        DatabaseReference db1 = FirebaseDatabase.getInstance().getReference().child("Users");
        db1.orderByChild("producersearch").equalTo(Country+Category+Amount).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                producerfindersearch_1_adapter adapter = new producerfindersearch_1_adapter(producerfindersearch1.this,list);
