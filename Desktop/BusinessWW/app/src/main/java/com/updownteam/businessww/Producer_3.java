...
public class Producer_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_producer_3);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(category.matches("")){
                    Toast.makeText(Producer_3.this,"Sorry,you must write something",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                db1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("Producer")){
                            ...
                            Intent i =new Intent(Producer_3.this,InvestorMain2.class);
                            startActivity(i);
                        }else{
                            Intent i =new Intent(Producer_3.this,Producer_4.class);
