...
public class Qoy_1 extends FragmentActivity implements OnMapReadyCallback {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if(location != null || !location.equals("")){
                    Geocoder geocoder = new Geocoder(Qoy_1.this,Locale.ENGLISH);
                    try{
                    ...
                    if(addressList == null || addressList.isEmpty()){
                        Toast.makeText(Qoy_1.this, "Bu adda yer yoxdur!", Toast.LENGTH_LONG).show();
                        return false;
                    }
                    else {
                        ...
                        if(address.getLocality() == null || address.getLocality().matches("") || addressList.get(0) == null ){
                            ...
                            Submit.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    Intent  i =new Intent(Qoy_1.this,Activity_3.class);
                                    i.putExtra("FromPlace",city);
                                    i.putExtra("Type","Qoy1");
                                    startActivity(i);
                                    finish();
                                }
                            });
                ...
                if(location == null){
                    Toast.makeText(Qoy_1.this, "Zəhmət olmasa, bir yer adı axtarın!", Toast.LENGTH_LONG).show();
                    return false;
                }
                return false;
            }
