...
public class Qoy_8_7_2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private Spinner Pet;
    private Button Submit;
    private String TalkText;
    private String Cigar, CarYear, Price, FromPlace, ToPlace, Time, Month, Day, Year, MaxYer, CarNumber, CarBrand, Talk, Number,Music;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qoy_8_7_2);
        ...
        nav1.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.home:
                        Intent i =new Intent(Qoy_8_7_2.this,Activity_3.class);
                        startActivity(i);
                        break;
                    case R.id.contact:
                        Intent b = new Intent(Qoy_8_7_2.this,Search_2.class);
                        startActivity(b);
                        break;
                    case R.id.info:
                        Intent c = new Intent(Qoy_8_7_2.this,Qoy_1.class);
                        startActivity(c);
                        break;
                    case R.id.message:
                        Intent d = new Intent(Qoy_8_7_2.this,Message_1.class);
                        startActivity(d);
                        break;
                    case R.id.profilim:
                        Intent e = new Intent(Qoy_8_7_2.this,Info.class);
                        startActivity(e);
                        break;
                }
                return true;
        ...
        talkOptions.add("Maşında heyvana münasibətiniz necədir?");
        talkOptions.add("Maşında heyvan olmaz.");
        talkOptions.add("Maşında heyvan olar.");
        ...
        Pet = (Spinner) findViewById(R.id.pet);
        Pet.setOnItemSelectedListener(this);
        Pet.setAdapter(talkAdapter);
        ...
        if (Number == null) {
            ...
            Submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    String MusicText = Pet.getSelectedItem().toString();
                    if (MusicText.matches("")) {
                        Toast.makeText(Qoy_8_7_2.this, "Zəhmət olmasa, seçimi qeyd edin!", Toast.LENGTH_SHORT).show();
                    } else {
                        Intent i = new Intent(Qoy_8_7_2.this, Qoy_8_8_2.class);
                        i.putExtra("Cigar", Cigar);
                        i.putExtra("Pet",MusicText);
